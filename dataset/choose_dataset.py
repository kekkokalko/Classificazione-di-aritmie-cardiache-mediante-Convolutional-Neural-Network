...
from dataset.mioDatabase import ECG
...
def select_dataset(args):
    ...
    if args.dataset == "ImageNet":
        ...
        dataset_val = ConText(val, transform=make_transform(args, "val"))
        return dataset_train, dataset_val
    if args.dataset == "MioDatabase":
        dataset_train = ECG('./data/ecg', train=True, download=True, transform=make_transform(args, "train"))
        dataset_val = ECG('./data/ecg', train=False, transform=make_transform(args, "val"))
        return dataset_train, dataset_val
